...
- **Exception — non-code tasks**: Tasks that don't modify production code or tests (e.g., `.pen` design files, `issues/*.md`, `tasks/*.md`, `docs/`, `CONTEXT.md`, `AGENTS.md`, `.Codex/skills/`) do not require a work branch or PR. Commit directly to `main`.
