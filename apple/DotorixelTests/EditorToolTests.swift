...
// displayName coverage lives in LocalizationTests.swift
// (ToolDisplayNameLocalizationTests) — it pins en/ko/ja per case and keeps the
// "newly added tool fails until labeled" property via expectationsCoverAllTools.
