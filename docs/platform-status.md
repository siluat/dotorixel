...
| Reference Layer (timeline kind) | 🔧 | 🔧 | ⬜ | Core supports tracing, placement, and sampling. Web persists/excludes exports and shows kind icons; import UI and overlay pending |
