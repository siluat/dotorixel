...
| Selection / Marquee | 🔧 | 🔧 | ⬜ | Persistent Marquee with clipping, Delete, drag aids, drag-to-move, persisted copy clipboard, undoable commits, Reference no-op. Paste, nudge, action bar pending |
