...
| Per-frame duration | ✅ | ✅ | ✅ | Default 100ms (10fps); 1–60000ms clamp at the shell boundary (core trusts the value). Both shells: undoable active-frame corner editor (ms + derived fps), invalid entries revert. Web persisted (V7); Apple persistence pending |
