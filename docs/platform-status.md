...
| Reference Layer (timeline kind) | 🔧 | ⬜ | ⬜ | Tracing layer kind; excluded from exports. Core: auto-fit placement on import (≤ natural), atomic placement update, anchor-following canvas resize (scale preserved), silent drawing-tool no-ops. Shells pending via 112/113+ |
