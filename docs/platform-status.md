...
| Per-frame duration | ✅ | ✅ | ✅ | 100ms default; out-of-range integers clamp to 1–60000ms at the shell boundary; invalid entries revert to the stored value. Undoable and persisted on both shells. Apple drafts commit to their originating tab/Frame; late focus events preserve Undo/Redo. |
