...
| Apple Pencil | — | — | ✅ | Draws immediately (no finger deferral). Touching pencil outranks fingers: begins over a resting palm, an active stroke ignores them entirely, pinch/pan suppressed until it lifts |
