...
| Reference Layer (timeline kind) | 🔧 | 🔧 | ⬜ | Singleton fixed-bottom underlay; import/replace, fit-to-canvas, drag, corner scale, keyboard nudge. Cursor/sampling polish remain |
