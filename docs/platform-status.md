...
| Display on canvas | — | ✅ | 🔧 | Web uses persistent movable multi-window references. Apple renders one underlay below pixels, positioned on-canvas by a placement overlay; relaunch persistence remains pending |
