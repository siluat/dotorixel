...
| Selection / Marquee | 🔧 | 🔧 | ⬜ | Document-scoped Marquee persists; pixel clear, clipping, Reference-active no-op, and touch long-press suppression inside selection. Move/copy/paste pending |
