...
Selection defines now support Shift/latch squares with live modifier changes,
and the localized status bar reports committed Marquee bounds. Floating
movement remains in issue 272.
