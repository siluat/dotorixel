...
- [250 — HSV picker assistive adjustability](../issues/250-hsv-picker-assistive-adjustability.md) — web keyboard + Apple VoiceOver operation for the drag-only picker; flagged on PR #330. ready-for-agent (Option A — split axes; agent brief in issue)
