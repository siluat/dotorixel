...
- Apple Reference placement deactivation cleanup — leaving the Reference Layer during a placement gesture retains its draft; cancel on successful layer deactivation and verify reselect/commit behavior. Pre-existing path identified in PR #387; separate from the behavior-preserving Edit lifecycle refactor.
